...
//  FinanceApp
//
//  Creado por Adiel Luna on 3/25/19.
...
class BankAccountViewController: ATCGenericCollectionViewController {
    ...
    init(uiConfig: ATCUIGenericConfigurationProtocol,
        ...
        let emptyViewModel = CPKEmptyViewModel(image: nil, title: "No Bank Account", description: "We cannot find this bank account.", callToAction: nil)
