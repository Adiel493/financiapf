...
//  DashboardApp
//
//  Creado por Adiel Luna on 8/8/18.
...
class ATCLoginScreenManager: ATCLoginScreenDelegate {
    ...
    fileprivate func showLoginError(_ title: String? = "Las credenciales de acceso son incorrectas. Por favor vuelva a intentar".localizedCore) {
